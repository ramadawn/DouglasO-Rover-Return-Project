...
def telemetry(sid, data):
    ...
    print("Samples = ", Rover.send_pickup, Rover.near_sample)
    print("GROUND = ",len(ground_truth_3d))
    if data:
        global Rover
        ...
        if np.isfinite(Rover.vel):
            ...
            print("map data used = ",Rover.mapmake)
            print("map data not useable = ", Rover.nomapmake)
